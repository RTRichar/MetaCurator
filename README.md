...
The goal of MetaCurator is to create a flexible and generalizable alternative to the CRUX module of ANACAPA (https://github.com/limey-bean/Anacapa/) and the conserved marker curation mode of Metaxa2_dbb (doi: 10.1093/bioinformatics/bty482).
